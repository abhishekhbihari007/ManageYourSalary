...
function ShaderPlane() {
  ...
  useFrame((state) => {
    ...
    // Scale the plane to cover full viewport width - ensure it covers entire screen
    if (meshRef.current) {
      const aspect = width / height;
      // Scale to ensure full coverage with extra padding to avoid black edges
      const scaleX = Math.max(aspect * 2, 4);
      const scaleY = 2;
...
export function ShaderBackground() {
  ...
  return (
    <div 
      ref={canvasRef} 
      className="bg-black absolute -z-10" 
      aria-hidden
      style={{ 
        width: '100vw',
        minWidth: '100vw',
    ...
    >
      ...
      <div 
        className="pointer-events-none absolute bg-gradient-to-t from-black/30 via-transparent to-black/20"
        style={{
          width: '100vw',
          minWidth: '100vw',
          maxWidth: '100vw',
